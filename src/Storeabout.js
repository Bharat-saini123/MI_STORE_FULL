...
useEffect(()=>{
  ...
  return (<div style={{paddingTop:"8rem",backgroundColor:"black"}}>
   
<div className='main-about-phone-photo-section' >
...
return (
 ...
 <div className="first-photo-about-mains">
  <figure style={{width:"100%",height:"95vh"}}><img src={currentElement.front.img1} alt="" style={{width:"100%",height:"100%",}}/></figure>
 </div>
 <div>
